...
import 'grave_create_widget.dart' show GraveCreateWidget;
import 'package:flutter/material.dart';

class GraveCreateModel extends FlutterFlowModel<GraveCreateWidget> {
  ///  Local state fields for this page.

  String selectedPage = '住所を入力';
  ...
  LocationsRecord? locationRef;
  // Stores action output result for [Backend Call - Create Document] action in Button widget.
  GravesRecord? graveRef;
  // State field(s) for TextField widget.
  ...
  // Stores action output result for [Backend Call - Create Document] action in Button widget.
  LocationsRecord? locationRefWithMap;
  // Stores action output result for [Backend Call - Create Document] action in Button widget.
